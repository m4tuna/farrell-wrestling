...
class acf_field_repeater extends acf_field
{
	...
	*/
	...
	function input_admin_enqueue_scripts()
	{
		...
		wp_register_script( 'acf-input-repeater',  get_template_directory_uri().'/acf-repeater/js/input.js', array('acf-input'), $this->settings['version'] );
		wp_register_style( 'acf-input-repeater',   get_template_directory_uri().'/acf-repeater/css/input.css', array('acf-input'), $this->settings['version'] ); 
